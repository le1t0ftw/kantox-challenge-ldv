...
def list_buckets():
    ...
    return {"buckets": [b["Name"] for b in buckets["Buckets"]], "version": SERVICE_VERSION}
...
def list_parameters():
    ...
    return {"parameters": [p["Name"] for p in params["Parameters"]], "version": SERVICE_VERSION}
...
def get_parameter(name: str):
    ...
    return {"name": name, "value": response["Parameter"]["Value"], "version": SERVICE_VERSION}